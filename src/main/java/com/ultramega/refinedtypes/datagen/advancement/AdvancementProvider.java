...
public class AdvancementProvider implements AdvancementSubProvider {
    @Override
    public void generate(final Provider provider, final Consumer<AdvancementHolder> consumer) {
        Advancement.Builder.advancement()
            .parent(createIdentifier("drives"))
            .display(Items.getEnergyStorageDisk(EnergyStorageVariant.K_64).getDefaultInstance(),
